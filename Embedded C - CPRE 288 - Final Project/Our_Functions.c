...
void int2char(int input){
        ...
        for(i = 0; i < count; i++){
            ...
            uart_sendChar(modarray[i]);
         }
}

/** END INTEGER TO CHAR OUTPUT **/


//void auto_drive(oi_t* oi_sensor, object_t* object[10], scan_data_t* sensor_data[181])
//{
//    float safe_dist = 0;
//    bool zone_found = 0;
//
...
//        while(!zone_found)
//        {
//            ScanVals(sensor_data, 0, 180);
//            obj_detection(object, sensor_data, 0, 180, 0);
//            safe_dist = object_clear_check(object);
//
//            move_forward(oi_sensor, safe_dist);
//
//            if(current_status & left_bump)
//            {
//                move_backward(oi_sensor, 3);
//                turn_clockwise(45);
//                break;
//            }
//
//            if(current_status & right_bump)
//            {
//                move_backward(oi_sensor, 3);
//                turn_counter_clockwise(45);
//                break;
//            }
//
//            if(current_status & hole_left)
//            {
//                move_backward(oi_sensor, 3);
//                turn_clockwise(45);
//                break;
